 ...
 * {@link salutem.visit.service.impl.LocationLocalServiceImpl} and is the
 ...
 * @see salutem.visit.service.impl.LocationLocalServiceImpl
 * @generated
 */
public class LocationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link salutem.visit.service.impl.LocationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static salutem.visit.model.Location addLocation(
	...
	*/
	public static salutem.visit.model.Location createLocation(long locationId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Location deleteLocation(long locationId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Location deleteLocation(
		salutem.visit.model.Location location)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static salutem.visit.model.Location fetchLocation(long locationId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Location getLocation(long locationId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<salutem.visit.model.Location> getLocations(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Location updateLocation(
		salutem.visit.model.Location location)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static salutem.visit.model.Location addLocation(long patientId,
		int year, int month, int day, double lat, double lon)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addLocation(patientId, year, month, day, lat, lon);
	}
	...
	public static java.util.List<salutem.visit.model.Location> findByPatientIdAndYear(
		...
		return getService().findByPatientIdAndYear(patientId, year);
	}
	...
	public static java.util.List<salutem.visit.model.Location> findByPatientIdAndYearAndMonth(
		...
		return getService()
				   .findByPatientIdAndYearAndMonth(patientId, year, month, day);
	}

	public static java.util.List<salutem.visit.model.Location> findByPatientIdAndYearAndMonthAndLatAndLon(
		long patientId, int year, int month, int day, double lat, double lon) {
		return getService()
				   .findByPatientIdAndYearAndMonthAndLatAndLon(patientId, year,
			month, day, lat, lon);
	}
