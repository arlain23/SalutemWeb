...
/**
 * Provides the local service interface for WeightMap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Aneta Andrzejewska
 * @see WeightMapLocalServiceUtil
...
public interface WeightMapLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WeightMapLocalServiceUtil} to access the weight map local service. Add custom service methods to {@link salutem.visit.service.impl.WeightMapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
