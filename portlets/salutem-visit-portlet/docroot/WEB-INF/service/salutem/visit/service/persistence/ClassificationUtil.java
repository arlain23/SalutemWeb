...
/**
 * The persistence utility for the classification service. This utility wraps {@link ClassificationPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ClassificationUtil {
	 ...
	 */
	public static void clearCache(Classification classification) {
		getPersistence().clearCache(classification);
	}
	 ...
	 */
	public static List<Classification> findWithDynamicQuery(
	 ...
	 */
	public static Classification update(Classification classification)
		throws SystemException {
		return getPersistence().update(classification);
	}
	...
	public static Classification update(Classification classification,
		...
		return getPersistence().update(classification, serviceContext);
	}
	...
	*/
	public static java.util.List<salutem.visit.model.Classification> findByPatientId(
		long patientId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Classification findByPatientId_First(
		long patientId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Classification fetchByPatientId_First(
		long patientId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Classification findByPatientId_Last(
		long patientId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			salutem.visit.NoSuchClassificationException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Classification fetchByPatientId_Last(
		long patientId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Classification[] findByPatientId_PrevAndNext(
		long classificationId, long patientId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			salutem.visit.NoSuchClassificationException {
		return getPersistence()
				   .findByPatientId_PrevAndNext(classificationId, patientId,
			orderByComparator);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(classification);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(classifications);
	}
	...
	*/
	public static salutem.visit.model.Classification create(
		long classificationId) {
		return getPersistence().create(classificationId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Classification remove(
		long classificationId)
		throws com.liferay.portal.kernel.exception.SystemException,
			salutem.visit.NoSuchClassificationException {
		return getPersistence().remove(classificationId);
	}

	public static salutem.visit.model.Classification updateImpl(
		salutem.visit.model.Classification classification)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(classification);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Classification findByPrimaryKey(
		long classificationId)
		throws com.liferay.portal.kernel.exception.SystemException,
			salutem.visit.NoSuchClassificationException {
		return getPersistence().findByPrimaryKey(classificationId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static salutem.visit.model.Classification fetchByPrimaryKey(
		long classificationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(classificationId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<salutem.visit.model.Classification> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ClassificationPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ClassificationPersistence)PortletBeanLocatorUtil.locate(salutem.visit.service.ClpSerializer.getServletContextName(),
					ClassificationPersistence.class.getName());

			ReferenceRegistry.registerReference(ClassificationUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ClassificationPersistence persistence) {
	}

	private static ClassificationPersistence _persistence;
}