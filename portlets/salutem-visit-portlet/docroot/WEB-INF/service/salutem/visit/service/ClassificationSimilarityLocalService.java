...
/**
 * Provides the local service interface for ClassificationSimilarity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Aneta Andrzejewska
 * @see ClassificationSimilarityLocalServiceUtil
...
public interface ClassificationSimilarityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClassificationSimilarityLocalServiceUtil} to access the classification similarity local service. Add custom service methods to {@link salutem.visit.service.impl.ClassificationSimilarityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
