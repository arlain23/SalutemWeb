...
public class LocationLocalServiceWrapper implements LocationLocalService,
	...
	*/
	...
	public salutem.visit.model.Location addLocation(long patientId, int year,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _locationLocalService.addLocation(patientId, year, month, day,
			lat, lon);
	}
	...
	public java.util.List<salutem.visit.model.Location> findByPatientIdAndYearAndMonthAndLatAndLon(
		...
		return _locationLocalService.findByPatientIdAndYearAndMonthAndLatAndLon(patientId,
