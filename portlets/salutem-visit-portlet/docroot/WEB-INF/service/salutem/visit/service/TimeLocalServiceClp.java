 ...
 * @generated
 */
public class TimeLocalServiceClp implements TimeLocalService {
	public TimeLocalServiceClp(InvokableLocalService invokableLocalService) {
		_invokableLocalService = invokableLocalService;

		_methodName0 = "addTime";

		_methodParameterTypes0 = new String[] { "salutem.visit.model.Time" };

		_methodName1 = "createTime";

		_methodParameterTypes1 = new String[] { "long" };

		_methodName2 = "deleteTime";

		_methodParameterTypes2 = new String[] { "long" };

		_methodName3 = "deleteTime";

		_methodParameterTypes3 = new String[] { "salutem.visit.model.Time" };
		...
		_methodName10 = "fetchTime";

		_methodParameterTypes10 = new String[] { "long" };

		_methodName11 = "getTime";
		...
		_methodName13 = "getTimes";

		_methodParameterTypes13 = new String[] { "int", "int" };

		_methodName14 = "getTimesCount";

		_methodParameterTypes14 = new String[] {  };

		_methodName15 = "updateTime";

		_methodParameterTypes15 = new String[] { "salutem.visit.model.Time" };
		...
		_methodName19 = "getTimeByDoctorIdAndPatientId";

		_methodParameterTypes19 = new String[] { "long", "long" };

		_methodName20 = "getFinishedByDoctorId";

		_methodParameterTypes20 = new String[] { "long" };

		_methodName21 = "getTimesByDoctorIdDayMonthAndYear";

		_methodParameterTypes21 = new String[] { "long", "int", "int", "int" };

		_methodName22 = "getPlannedVisits";

		_methodParameterTypes22 = new String[] {
				"long", "int", "int", "int", "long"
			};

		_methodName23 = "getTimeQueueInfo";

		_methodParameterTypes23 = new String[] { "long", "int", "int", "int" };

		_methodName24 = "getTimesByPatientId";

		_methodParameterTypes24 = new String[] { "long" };

		_methodName25 = "getMeanTime";
	...
	public salutem.visit.model.Time addTime(salutem.visit.model.Time time)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(time) });
		}
		catch (Throwable t) {
		...
		return (salutem.visit.model.Time)ClpSerializer.translateOutput(returnObj);
	}
	...
	public salutem.visit.model.Time createTime(long timeId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { timeId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public salutem.visit.model.Time deleteTime(long timeId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { timeId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public salutem.visit.model.Time fetchTime(long timeId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { timeId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public salutem.visit.model.Time getTime(long timeId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { timeId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<salutem.visit.model.Time> getTimes(int start, int end)
		...
		return (java.util.List<salutem.visit.model.Time>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public salutem.visit.model.Time getFinishedByDoctorId(long doctorId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					_methodParameterTypes20, new Object[] { doctorId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<salutem.visit.model.Time> getTimesByDoctorIdDayMonthAndYear(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					new Object[] { doctorId, visitDay, visitMonth, visitYear });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<salutem.visit.model.Time> getTimesByPatientId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName24,
					_methodParameterTypes24, new Object[] { patientId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public double getMeanTime(long patientId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName25,
					_methodParameterTypes25, new Object[] { patientId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
