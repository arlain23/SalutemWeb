...
import tul.salutem.NoSuchTestException;

import tul.salutem.model.Test;
import tul.salutem.model.impl.TestImpl;
import tul.salutem.model.impl.TestModelImpl;
...
public class TestPersistenceImpl extends BasePersistenceImpl<Test>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERNAME = new FinderPath(TestModelImpl.ENTITY_CACHE_ENABLED,
			TestModelImpl.FINDER_CACHE_ENABLED, TestImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERNAME =
		new FinderPath(TestModelImpl.ENTITY_CACHE_ENABLED,
			TestModelImpl.FINDER_CACHE_ENABLED, TestImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByusername",
			new String[] { String.class.getName() },
			TestModelImpl.USERNAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERNAME = new FinderPath(TestModelImpl.ENTITY_CACHE_ENABLED,
			TestModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Test> findByusername(String username) throws SystemException {
	 ...
	 */
	@Override
	public List<Test> findByusername(String username, int start, int end)
	...
	public List<Test> findByusername(String username, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Test test : list) {
				if (!Validator.equals(username, test.getUsername())) {
					list = null;
	 ...
	 */
	@Override
	public Test findByusername_First(String username,
		OrderByComparator orderByComparator)
		throws NoSuchTestException, SystemException {
		Test test = fetchByusername_First(username, orderByComparator);
	 ...
	 */
	@Override
	public Test fetchByusername_First(String username,
		OrderByComparator orderByComparator) throws SystemException {
		List<Test> list = findByusername(username, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Test findByusername_Last(String username,
		OrderByComparator orderByComparator)
		throws NoSuchTestException, SystemException {
		Test test = fetchByusername_Last(username, orderByComparator);
	 ...
	 */
	@Override
	public Test fetchByusername_Last(String username,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Test> list = findByusername(username, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Test[] findByusername_PrevAndNext(long testId, String username,
		OrderByComparator orderByComparator)
		throws NoSuchTestException, SystemException {
		...
		try {
			...
			array[0] = getByusername_PrevAndNext(session, test, username,
					orderByComparator, true);

			array[1] = test;

			array[2] = getByusername_PrevAndNext(session, test, username,
	...
	protected Test getByusername_PrevAndNext(Session session, Test test,
	...
	public void removeByusername(String username) throws SystemException {
		for (Test test : findByusername(username, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_USERNAME_USERNAME_1 = "test.username IS NULL";
	private static final String _FINDER_COLUMN_USERNAME_USERNAME_2 = "test.username = ?";
	private static final String _FINDER_COLUMN_USERNAME_USERNAME_3 = "(test.username IS NULL OR test.username = '')";
	...
	@Override
	public Test updateImpl(tul.salutem.model.Test test)
		throws SystemException {
		test = toUnwrappedModel(test);
		...
		if (isNew || !TestModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((testModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { testModelImpl.getOriginalUsername() };
				...
				args = new Object[] { testModelImpl.getUsername() };
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.tul.salutem.model.Test")));
