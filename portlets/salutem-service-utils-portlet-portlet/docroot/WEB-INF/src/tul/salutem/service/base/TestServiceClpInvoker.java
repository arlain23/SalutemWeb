...
public class TestServiceClpInvoker {
	public TestServiceClpInvoker() {
		...
		_methodName24 = "sayHello";

		_methodParameterTypes24 = new String[] { "java.lang.String" };

		_methodName25 = "checkUserAuthentication";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName24.equals(name) &&
			...
			return TestServiceUtil.sayHello((java.lang.String)arguments[0]);
		}

		if (_methodName25.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes25, parameterTypes)) {
			return TestServiceUtil.checkUserAuthentication((java.lang.String)arguments[0],
