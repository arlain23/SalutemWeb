 ...
 * @generated
 */
public class DoctorLocalServiceWrapper implements DoctorLocalService,
	ServiceWrapper<DoctorLocalService> {
	...
	*/
	...
	public salutem.doctor.model.Doctor createDoctor(long doctorId) {
		return _doctorLocalService.createDoctor(doctorId);
	}
	...
	*/
	...
	public salutem.doctor.model.Doctor deleteDoctor(long doctorId)
		...
		return _doctorLocalService.deleteDoctor(doctorId);
	}
	...
	*/
	...
	public salutem.doctor.model.Doctor fetchDoctor(long doctorId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _doctorLocalService.fetchDoctor(doctorId);
	}
	...
	*/
	...
	public salutem.doctor.model.Doctor getDoctor(long doctorId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _doctorLocalService.getDoctor(doctorId);
	}
	...
	*/
	...
	public java.lang.String getBeanIdentifier() {
		return _doctorLocalService.getBeanIdentifier();
	}
	...
	*/
	...
	public void setBeanIdentifier(java.lang.String beanIdentifier) {
		_doctorLocalService.setBeanIdentifier(beanIdentifier);
	}
	...
	public java.lang.Object invokeMethod(java.lang.String name,
		...
		return _doctorLocalService.invokeMethod(name, parameterTypes, arguments);
	}

	@Override
	public java.util.List<salutem.doctor.model.Doctor> getAllDoctors() {
		return _doctorLocalService.getAllDoctors();
	}

	@Override
	public java.util.List<salutem.doctor.model.Doctor> getAllDoctorsByGroupId(
		long groupId) {
		return _doctorLocalService.getAllDoctorsByGroupId(groupId);
	}

	@Override
	public java.util.List<com.liferay.portal.model.User> getAllUsersNotSalutemDoctors(
		long groupId, long companyId) {
		return _doctorLocalService.getAllUsersNotSalutemDoctors(groupId,
			companyId);
	}
	...
	public salutem.doctor.model.Doctor getDoctorByUserID(long userId,
		long groupId) {
		return _doctorLocalService.getDoctorByUserID(userId, groupId);
	}

	@Override
	public boolean existByUserId(long userId, long groupId) {
		return _doctorLocalService.existByUserId(userId, groupId);
	}
	...
	public salutem.doctor.model.Doctor addDoctor(long groupId, long companyId,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _doctorLocalService.addDoctor(groupId, companyId, userId,
			userName, firstName, middleName, surname, imageId);
	}
	...
	public salutem.doctor.model.Doctor updateDoctor(long doctorId, long imageId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _doctorLocalService.updateDoctor(doctorId, imageId);
	}

	/**
	 * @deprecated As of 6.1.0, replaced by {@link #getWrappedService}
	 */
	public DoctorLocalService getWrappedDoctorLocalService() {
	 ...
	 */
	public void setWrappedDoctorLocalService(
