...
import tul.salutem.entity.service.PatientLocalServiceUtil;
...
public class PatientLocalServiceClpInvoker {
	public PatientLocalServiceClpInvoker() {
		...
		_methodParameterTypes0 = new String[] { "tul.salutem.entity.model.Patient" };
		...
		_methodParameterTypes3 = new String[] { "tul.salutem.entity.model.Patient" };
		...
		_methodParameterTypes15 = new String[] {
				"tul.salutem.entity.model.Patient"
			};
		...
		_methodName40 = "getPatientByUserId";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return PatientLocalServiceUtil.addPatient((tul.salutem.entity.model.Patient)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return PatientLocalServiceUtil.deletePatient((tul.salutem.entity.model.Patient)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return PatientLocalServiceUtil.updatePatient((tul.salutem.entity.model.Patient)arguments[0]);
		}
		...
		if (_methodName40.equals(name) &&
			...
			return PatientLocalServiceUtil.getPatientByUserId(((Long)arguments[0]).longValue());
		}
