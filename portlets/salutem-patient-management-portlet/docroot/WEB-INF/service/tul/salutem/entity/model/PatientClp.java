...
import tul.salutem.entity.service.ClpSerializer;
...
public class PatientClp extends BaseModelImpl<Patient> implements Patient {
	...
	public void setPesel(int pesel) {
		...
		if (_patientRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setPesel", int.class);
	...
	public void setIdImage(String idImage) {
		...
		if (_patientRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setIdImage", String.class);

				method.invoke(_patientRemoteModel, idImage);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setBloodType(String bloodType) {
		...
		if (_patientRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setBloodType", String.class);

				method.invoke(_patientRemoteModel, bloodType);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	private Class<?> _clpSerializerClass = tul.salutem.entity.service.ClpSerializer.class;
}