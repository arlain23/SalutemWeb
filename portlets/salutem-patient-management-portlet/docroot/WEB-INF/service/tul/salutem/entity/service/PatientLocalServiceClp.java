...
public class PatientLocalServiceClp implements PatientLocalService {
	public PatientLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName19 = "getPatientByUserId";
	...
	public tul.salutem.entity.model.Patient addPatient(
		...
		return (tul.salutem.entity.model.Patient)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<tul.salutem.entity.model.Patient> getPatients(
		...
		return (java.util.List<tul.salutem.entity.model.Patient>)ClpSerializer.translateOutput(returnObj);
	}
